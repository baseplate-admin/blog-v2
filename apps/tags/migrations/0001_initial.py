    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('palette_json', models.JSONField(blank=True, default=list, help_text='Auto-generated color palette (list of RGB arrays).')),
                ('dominant_color_hex', models.CharField(blank=True, default='', help_text='Auto-generated dominant color in hex format.', max_length=7)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='renditions', to='tags.blogimage')),
            ],
            options={
